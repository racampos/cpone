...
export default function LinkToaster({
  ipfsLink,
  etherscanLink,
  showLinkToaster,
  setShowLinkToaster,
  ...
  showLinkToaster: boolean;
  setShowLinkToaster: any;
}) {
  return (
    <>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 w-0 flex-1 pt-0.5">
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                      Your NFT has been minted and uplaoded to IPFS!
                    </p>
